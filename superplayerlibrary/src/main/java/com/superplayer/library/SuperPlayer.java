...
public class SuperPlayer extends RelativeLayout {
     ...
     * 隐藏中间播放按钮
     */
    private void showCenterPLayControl(boolean show) {
    ...
    public void reSetSize(boolean isHide) {
        //int widthPixels = activity.getWindowManager().getDefaultDisplay().getWidth(); // 屏幕宽（像素，如：480px）
       // int heightPixels = activity.getWindowManager().getDefaultDisplay().getHeight(); // 屏幕高（像素，如：800p）
       // Log.e( "getDefaultDisplay", "screenWidth=" + widthPixels + "; screenHeight=" + heightPixels);
      /*  Log.e( "getDefaultDisplay", "staus=" + getStatusBarHeight(activity) + "; daohang=" + getDaoHangHeight(activity));

        Log.e("getDefaultDisplay", "resize"+isHide);
        Log.e("getDefaultDisplay","have::"+checkDeviceHasNavigationBar(activity));
        ...
        *//*DisplayMetrics metrics = new DisplayMetrics();
        ...
        if (isHide == false){
            heightPixels  = height;
            widthPixels = width-getDaoHangHeight(activity);;
        }else {
            heightPixels  = height;
            widthPixels = width+getDaoHangHeight(activity);
        }
        if (!portrait){
           *//* int heightPixels = activity.getResources().getDisplayMetrics().heightPixels;
            ...
            Log.e("getDefaultDisplay", "横屏height：：" + heightPixels + "::::::widthpixel:::" + widthPixels);
    ...
    public void initView() {
        ...
        Log.e("superPlayer", "initView");
        screenWidthPixels = activity.getResources().getDisplayMetrics().widthPixels;
        Log.e("superPlayer", "screenWidthPIxel::" + screenWidthPixels);
        $ = new Query(activity);
        ...
        contentView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                Log.e("supee", "globalLayout执行::");
                Log.e("supee", "rootHeight::" + contentView.getRootView().getHeight() + "::::height::" + contentView.getHeight());

                //比较Activity根布局与当前布局的大小
                int heightDiff = contentView.getRootView().getHeight() - contentView.getHeight();
                Log.e("supee", "eight::" + heightDiff);
                if (heightDiff > 100) {
    ...
    public void onConfigurationChanged(final Configuration newConfig) {
        Log.e("superPlayer", "onConfigurationChanged");
        portrait = newConfig.orientation == Configuration.ORIENTATION_PORTRAIT;
        doOnConfigurationChanged(portrait);
    }

    private void doOnConfigurationChanged(final boolean portrait) {
        Log.e("superPlayer", "DO !!! onConfigurationChanged:::"+portrait);
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (portrait) {
                        ...
                        Log.e("superPlayer", "else");
                        int heightPixels = activity.getResources().getDisplayMetrics().heightPixels;
                        int widthPixels = activity.getResources().getDisplayMetrics().widthPixels;

                        Log.e("superPlayer", "横屏height：：" + heightPixels + "::::::widthpixel:::" + widthPixels);
...
//	}
    ...
    private void updateFullScreenButton() {
        if (getScreenOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {// 全屏幕(横屏)
