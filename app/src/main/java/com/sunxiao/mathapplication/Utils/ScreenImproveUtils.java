package com.sunxiao.mathapplication.Utils;
...
/**
 * Created by NJ on 2017/12/28.
 */

public class ScreenImproveUtils {
    ...
    public static void assistActivity(View viewObserving) {
        new ScreenImproveUtils(viewObserving);
    }
    ...
    private ScreenImproveUtils(View viewObserving) {
